                ...
                <div class="mdl-card__supporting-text">
                    ...
                    <?php
                        if (! isset($_COOKIE['theme'])) {
                            ...
                            echo '<strong>To test this persistent cookie, close browser and then reopen this page</strong>';
                        }
                        if (! isset($_COOKIE['philosopher'])) {
                            echo '<p>Session PHILOSOPHER cookie not found</p>';
                        }
                        else {
                            echo '<p>The session PHILOSOPHER cookie value is : ' . $_COOKIE['philosopher'] . '</p>';
                            echo '<strong>To test this session cookie, click link below to go to another page in same domain</strong>';
                        }                        
                    ?> 
